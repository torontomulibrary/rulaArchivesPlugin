...
class rulaArchivesPluginConfiguration extends sfPluginConfiguration
{
  public static
  ...
  public function contextLoadFactories(sfEvent $event)
  {
    ...
    if ($context->getConfiguration()->isDebug())
    {
      ...
      $context->response->addStylesheet('/plugins/rulaArchivesPlugin/css/main.less', 'last', array('rel' => 'stylesheet/less', 'type' => 'text/css', 'media' => 'all'));
    }
    else
    {
      $context->response->addStylesheet('/plugins/rulaArchivesPlugin/css/main.css', 'last', array('media' => 'all'));
    }
  }
